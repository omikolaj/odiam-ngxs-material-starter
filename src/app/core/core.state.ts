...
import { initStateFromLocalStorageNgrx } from './meta-reducers/init-state-from-local-storage.reducer';
...
export const metaReducers: MetaReducer<AppState>[] = [initStateFromLocalStorageNgrx];
